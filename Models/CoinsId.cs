...
public record CoinsId
{
    ...
    public required IReadOnlyDictionary<string, DetailPlatforms1> DetailPlatforms { get; init; }
    ...
    [JsonPropertyName("categories_details")]
    public IReadOnlyList<CategoriesDetail>? CategoriesDetails { get; init; }
    ...
    public IcoData? IcoData { get; init; }
